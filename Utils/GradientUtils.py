...
@description: Gradient color tool class
"""
...
class GradientUtils:
    ...
    def _getValue(cls, value):
        """Turn a wide range of numbers into a small range
        :param cls:
        :param value:
        """
    ...
    def toJson(cls, gradient):
        """Transfer gradient into dictionary
        :param cls:
    ...
    def toGradient(cls, data):
        """Turn the dictionary into gradient
        :param cls:
