...
class TestWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        btn1 = QPushButton('Mouse hover 1', self, minimumHeight=38, toolTip='This is button 1')
        ToolTip.bind(btn1)
        layout.addWidget(btn1)

        btn2 = QPushButton('Mouse hover 2', toolTip='This is button 2')
        ToolTip.bind(btn2)
